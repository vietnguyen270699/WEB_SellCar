				...
				<div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-content">
							...
							<form class="form-horizontal" action="XuLySuaSanPham" method="post">
								<fieldset>
									<div class="control-group">
										<label class="control-label">Mã sản phẩm</label>
										<div class="controls">
											<input class="input-xlarge uneditable-input" name="masanpham" value="${xemsp.getMasanpham()}">
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<input class="input-xlarge focused" id="focusedInput"
												type="text" name="tensanpham" value="${xemsp.getTensanpham() }">
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<input class="input-xlarge focused" id="focusedInput"
												type="text" name="giasanpham" value="${xemsp.getGiaban() }">
										</div>
									</div>
									<div class="control-group">
										<label class="control-label" for="focusedInput">Mã Nhà Cung Cấp</label>
										<div class="controls">
											<input class="input-xlarge focused" id="focusedInput"
												type="text" name="manhacungcap" value="${xemsp.getManhacungcap()}">
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<input class="input-xlarge focused" id="focusedInput"
												type="text" name="hinhanh" value="${xemsp.getHinhanh()}">
										</div>
									</div>
									
									<div class="form-actions">
										<button type="submit" class="btn btn-primary">Lưu thay đổi</button>
										<a class="btn btn-danger" href="AdminXuLyXemDanhSachSanPham">Hủy</a>
									</div>
								</fieldset>
							</form>
