...
<style type="text/css">
body {
	background: url(img/backgroundlogin.jpg) !important;
}
</style>
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="login-box">
					...
					<form class="form-horizontal" action="SuLyDangNhap" method="post">
						<fieldset>

							<div class="input-prepend" title="Username">
								<span class="add-on"><i class="halflings-icon user"></i></span>
								<input class="input-large span10" name="tentaikhoan"
							...
							<div class="input-prepend" title="Password">
								...
								<input class="input-large span10" name="matkhau" id="password"
									type="password" placeholder="type password" />
							</div>
							
							<div class="clearfix"></div>

							<p style="color: red"><%=mesname%></p>
							<div class="button-login">
								<button type="submit" class="btn btn-primary">Đăng nhập</button>
							</div>
							<div class="button-login">
								<a class="btn btn-primary" href="account.jsp"> Tạo tài khoản</a>
							</div>
								<div class="button-login">
								<a class="btn btn-primary" href="forgotpass.jsp"> Quên mật khẩu</a>
							</div>
							<div class="clearfix"></div>
