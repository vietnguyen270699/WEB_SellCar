	...
	<div class="container-fluid-full">
		<div class="row-fluid">
			...
			<div id="content" class="span10">
				...
				<ul class="breadcrumb">
					<li><i class="icon-home"></i> <a href="#">Trang chủ</a> <i
						class="icon-angle-right"></i></li>
					<li><i class="icon-edit"></i> <a href="#">Quản lý tài
							khoản</a></li>
				</ul>
				<div>
					<a class="btn btn-success" href="adminformaddsp.jsp">Thêm sản phẩm</a>
				</div>
							...
							<table
								...
								<tbody>
									<c:forEach items="${listSP}" var="dssanpham">
										...
										<tr>
											<td>${dssanpham.getMasanpham()}</td>
											<td class="center">${dssanpham.getTensanpham()}</td>
											<td class="center">${dssanpham.getGiaban()}</td>
											<td class="center"><span class="label label-success">${dssanpham.getManhacungcap()}</span>
											</td>
											<td class="center">${dssanpham.getHinhanh()}</td>

											<td class="center"><a class="btn btn-success"
												href="XuLyXemSuaSanPham?maSanPham=${dssanpham.getMasanpham()}">Sửa
													<i class="halflings-icon white zoom-in"></i>
											</a> <a class="btn btn-danger"
												href="AdminXoaSanPham?maSanPham=${dssanpham.getMasanpham()}">Xóa
